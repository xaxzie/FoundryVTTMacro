...
2. **JB2A - Jules&Ben's Animated Assets** (ESSENTIAL) - Visual effects  
3. **Warp Gate** (REQUIRED) - Crosshair targeting system
4. **Carousel Combat Track** (REQUIRED) - Turn order management
