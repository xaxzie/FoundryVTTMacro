...
| Macro               | Description                                                      | Requirements              |
| ------------------- | ---------------------------------------------------------------- | ------------------------- |
| `bubbles.js`        | **RPG-COMPLIANT** Dual projectile attack with elemental variants | JB2A, Portal, 1 caster    |
...
| ----------------------- | ------------------------------------------------- | ------------------------------------------ |
| `actor-validation.js`   | Token and actor validation functions              | Copy validation functions into your macros |
| `stance-detection.js`   | Combat stance detection and mana cost calculation | Copy stance functions into your macros     |
| `character-stats.js`    | Character statistics with injury adjustment       | Copy stat functions into your macros       |
| `portal-targeting.js`   | Crosshair targeting using Portal module           | Copy targeting functions into your macros  |
| `actor-detection.js`    | Actor detection at target locations               | Copy detection functions into your macros  |
| `damage-calculation.js` | Damage/healing rolls with stance mechanics        | Copy damage functions into your macros     |
| `element-selection.js`  | Element selection dialogs and properties          | Copy element functions into your macros    |
| `chat-formatting.js`    | Professional chat message formatting              | Copy formatting functions into your macros |
| `sequencer-helpers.js`  | Legacy reusable utility functions                 | Copy functions into your macros            |
| `README.md`             | **Complete utility reference guide**              | Documentation for all utility functions    |
...
1. **ora/bubbles.js** - **First fully RPG-compliant spell (TESTED ON SERVER)**
2. **lightning-teleport.js** - Spectacular teleportation effect
3. **fireball.js** - Classic D&D fireball spell
4. **chain-lightning.js** - Multi-target lightning
5. **ora/blizzard.js** - Devastating ice storm effect
6. **moctei/void-prison.js** - Epic shadow prison
...
4. **ora/bubbles.js** - **RPG-compliant spell with all features**
5. **utilities/README.md** - **Complete utility function reference**
...
1. **Ora's RPG Spells**: **bubbles.js** (RPG-compliant) → frost-bolt.js → ice-wall.js → blizzard.js
2. **Moctei's Combo**: shadow-step.js → umbral-strike.js → void-prison.js
3. **New Spell Development**: Start with **utilities/README.md** → Copy functions from **bubbles.js** pattern
