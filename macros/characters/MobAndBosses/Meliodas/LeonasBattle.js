...
(async () => {
    ...
    const ANIMATION_LIBRARY = {
        // === LEONAS ANIMATIONS ===
        "leonas_claws": {
            name: "🩸 Leonas - Griffes Sombres",
            description: "Leonas - Attaque de griffes rouge sombre sur la cible",
            mode: "target",
            sequence: [
                {
                    file: "jb2a_patreon.claws.200px.dark_red",
                    atLocation: "target",
                    scale: 1.0
                }
            ]
        ...
        "leonas_bite": {
            name: "🦷 Leonas - Morsure Féroce",
            description: "Leonas - Attaque de morsure orange sur la cible",
            mode: "target",
            sequence: [
                {
                    file: "jb2a_patreon.bite.400px.orange",
                    atLocation: "target",
                    scale: 1.0
                }
            ]
        ...
        "leonas_fist": {
            name: "👊 Leonas - Coup de Poing",
            description: "Leonas - Attaque de poing rouge du lanceur vers la cible",
            mode: "projectile",
            sequence: [
                {
                    file: "jb2a.melee_generic.creature_attack.fist.001.red.3",
                    atLocation: true,
                    stretchTo: "target",
                    scale: 1.0
                }
        ...
        "leonas_power_emanation": {
            name: "⚡ ?? - Émanation de Puissance raté",
            description: " Aura de puissance émanant du token",
            mode: "self",
            sequence: [
                {
        ...
        // === MERLIN ANIMATIONS ===
        "merlin_vortex_portal": {
            name: "🌀 Merlin - Portail Vortex",
            description: "Merlin - Portail tourbillonnant noir avec auras bleues persistantes",
            mode: "target",
            sequence: [
                {
                    file: "jb2a.template_circle.aura.04.inward.001.loop.part02.refraction",
                    atLocation: "target",
                    scale: 1.5,
                    opacity: 0.6,
                    belowTokens: true,
        ...
        "caster_aura_blue": {
            name: "🔵 Aura Bleue sur Lanceur",
            description: "Aura bleue attachée et persistante sur le token",
            mode: "self",
            sequence: [
                {
                    file: "jb2a.template_circle.aura.03.outward.004.complete.combined.blue",
                    atLocation: true,
                    attachTo: true,
                    scaleToObject: 3.5,
                    opacity: 0.9,
