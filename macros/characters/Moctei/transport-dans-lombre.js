...
(async () => {
    ...
    async function teleportTokenWithAdvancedMacros(token, destination) {
        ...
        try {
            ...
            if (!teleportMacro) {
                ui.notifications.error("Macro 'Moctei Teleport Helper' non trouvée ! Assurez-vous qu'elle existe et est configurée pour s'exécuter en tant que GM.");
                return false;
            }
            ...
            console.log(`[Moctei] Résultat de la macro helper:`, result);
